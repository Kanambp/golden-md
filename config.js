...
module.exports = {
    ...
    BOT_NAME:              process.env.BOT_NAME || "GOLDEN BOY MD",
    OWNER_NUMBER:          process.env.OWNER_NUMBER || "254114148625",
    OWNER_NAME:            process.env.OWNER_NAME || "GOLDEN BOY MD",
    DESCRIPTION:           process.env.DESCRIPTION || "GOLDEN BOY MD Bot",
    ALIVE_IMG:             process.env.ALIVE_IMG || "https://files.catbox.moe/7ty2xw.png",
    LIVE_MSG:              process.env.LIVE_MSG || "GOLDEN BOY MD is active",
    ...
    AUTO_STATUS_MSG:       process.env.AUTO_STATUS_MSG || "Seen by GOLDEN BOY MD",
    ...
    STATUS_MSG:            process.env.STATUS_MSG    || 'GOLDEN BOY MD 💖 SUCCESSFULLY VIEWED YOUR STATUS',
    READ_MESSAGE:          toBool(process.env.READ_MESSAGE,          false),
    AUTO_REACT_NEWSLETTER:   toBool(process.env.AUTO_REACT_NEWSLETTER,   false),
